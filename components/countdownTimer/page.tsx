	...
	return (
		<>
			...
			>
				...
				<div className="relative h-60 flex items-center w-9/12 mx-auto">
					{/* Countdown Timer Section - Always at top */}
					<div className="flex flex-col justify-center items-center gap-4 z-10 w-full px-24">
						{/* Days */}
						<div className="flex items-center justify-center gap-4 w-auto h-fit">
							<div className="flex flex-col items-center gap-2 max-md:gap-1">
								<div className="text-center text-blue_3 text-2xl font-medium">
									Days
								</div>
								<div className="w-24 h-24 bg-blue_3 rounded-md flex items-center justify-center max-md:size-20">
									<span className="text-white text-5xl max-md:text-4xl font-normal">
										{timeLeft.days}
									</span>
								</div>
							</div>
							<div className="text-purple_4 text-5xl max-md:text-4xl pt-5">
								:
							</div>
							{/* Hours */}
							<div className="flex flex-col items-center gap-2 max-md:gap-1">
							...
							<span className="text-blue_3 text-5xl max-md:text-4xl pt-5">
								:
							</span>
							{/* Minutes */}
							<div className="flex flex-col items-center gap-2 max-md:gap-1">
						...
						<div className="flex flex-col justify-center items-center md:items-start mb-4 md:mb-0">
							<p className="text-center w-full text-blue_3 text-xl font-medium">
							...
							<div className="flex items-center">
								<div className="flex flex-row gap-4">
									<Image
										...
										className="w-7 h-7"
									/>
									<div className="text-center text-blue_3 text-lg font-medium">
					...
					<div
						className="w-full h-2/3 bottom-0 rounded-xl backdrop-blur-sm absolute z-0"
						style={{
							background:
					...
					{/* Content Container */}
					<div className="flex justify-center items-center w-full px-20 z-[5] mt-20">
						{/* Booklet Button */}
						<button
