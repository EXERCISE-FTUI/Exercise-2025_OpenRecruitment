...
const SmallerWidthDashboard = ({userData}) => {
	return (
		<div className="w-full max-w-[431px] mx-auto flex flex-col items-start p-8">
			...
			<div className="w-full p-[13.92px] rounded-[6.96px] shadow-[0px_0.5799999833106995px_6.960000038146973px_0px_rgba(0,0,0,0.08)] flex flex-col gap-[13.92px]">
				...
				<div className="flex flex-col gap-[6.96px]">
					<div className="text-[#1e1e1e] text-xs font-medium font-['Inter']">
						Email
					</div>
					...
					<div className="px-[13.92px] py-[6.96px] rounded border border-[#889da8] flex justify-between">
						<div className="w-[212.86px] flex flex-col gap-[9.28px]">
							...
							<div className="flex gap-[13.92px]">
								...
								<div className="text-[#1e1e1e] text-[10.44px] font-normal font-['Inter'] underline">
									link story upload
								</div>
							</div>
							<div className="flex gap-[13.92px]">
						...
						<div className="flex flex-col gap-[9.28px] items-center">
							<div className="text-[#88ab7b] text-[10.44px] font-medium">
								Submitted
							</div>
							<div className="text-[#889da8] text-[10.44px]">
								Empty
							</div>
							<div className="text-[#889da8] text-[10.44px]">
								Empty
						...
						<div
							className={`flex flex-col gap-[9.28px] items-center text-[10.44px]
                      ${
				...
				<div className="flex justify-center gap-[18.56px] pt-[6.96px]">
					...
					<Link
						...
						className="w-[180.96px] h-[27.84px] px-[13.92px] py-[6.96px] bg-[#55457e] rounded text-neutral-50 text-xs font-normal font-['Inter']"
					>
