					...
					<div className="w-full max-w-[1200px] flex flex-col px-4 md:px-6 lg:px-8">
						...
						<div className="flex flex-col lg:flex-row justify-start items-start gap-8 lg:gap-16 pb-[36px]">
							...
							<div className="flex-1 flex-col gap-3 max-w-full lg:max-w-[569px]">
								<div className="text-white text-xl md:text-2xl font-['Inter'] font-normal">
									Description
								</div>
						...
						<div className="h-[50px] flex justify-center items-center">
							<Link
								href="/login"
								className="h-[50px] px-6 py-2 bg-neutral-100 rounded-xl shadow-[0px_1px_12px_0px_rgba(157,152,179,0.25)] flex items-center justify-center transition-all duration-300"
							>
								<span className="text-[#55457e] text-[28px] font-bold px-16 tracking-wide">
									Join us now!
								</span>
							</Link>
						</div>
