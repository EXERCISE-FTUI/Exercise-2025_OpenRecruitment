...
export const projectData = {
    "project1": {
        ...
        description: "Developed a comprehensive online voting platform for the FTUI General Election (PEMIRA FTUI).",
        img: img1
    },
    "project2": {
        title: "Seramu Coffee",
        description: "In collaboration with Seramu Coffee, we developed Indonesia's first fully customizable automatic coffee machine with QRIS payment integration and a self-service system.",
        img: img2
    },
    "project3": {
        title: "URALA Indonesia Company Website",
        description: "We developed a professional and user-centric company website for URALA International, a full-service digital Public Relations and web solutions group operating across the Asia-Pacific region.",
        img: img3
    },
    "project4": {
        title: "Bluetooth Positioning",
        description: "We developed a mobile application for an indoor positioning system using Bluetooth beacons with ESP32.",
        img: img4
    },
    "project5": {
